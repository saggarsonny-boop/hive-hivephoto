...
-- HivePhoto — photos, people, albums
...
CREATE INDEX idx_photos_user_taken_at ON photos (user_id, taken_at DESC);
CREATE INDEX idx_photos_user_sha256 ON photos (user_id, sha256);
...
CREATE INDEX idx_photos_ai_description_trgm
